...
className={`flex-1 whitespace-nowrap px-4 py-2 text-body transition-colors duration-150 focus:outline-none ${tab.value === activeTab ? 'border-b-2 border-primary text-primary active' : 'border-b-2 border-transparent text-neutral-600'}`}
            >
              <span>{tab.label}</span>
            </button>
      ))}
